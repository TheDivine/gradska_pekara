...
<head>
    ...
    <title><?php echo  $subt. ' &raquo; ' .$glTitle;?></title>
    
    <meta name="keywords" content="<?php echo $glKeywords; ?>">
    <meta name="description" content="<?php echo $glDescription; ?>">
...
<body>
    ...
    <script> var _gaq=[['_setAccount',<?php echo $glGoogleAnalytics; ?>],['_trackPageview']];
